import random
categorias_palabras = {
  "animales": [ "gato", "perro", "elefante", "tigre", "leon", "jirafa", "zebra", "mono", "delfin", "rinoceronte" ],
  ...
  "deportes": [ "futbol", "baloncesto", "tenis", "natasion", "voleibol", "golf", "beisbol", "atletismo", "hockey", "boxeo" ],
  ...
  "instrumentos": [ "guitarra", "piano", "bateria", "violin", "flauta", "tronmpeta", "arpa", "clarinete", "saxofon", "tambor" ],
  "profesiones": [ "doctor", "ingeniero", "maestro", "abogado", "arquitecto", "enfermera", "policia", "bombero", "chef", "periodista" ],
  "marcas": [ "nike", "adidas", "microsoft", "pepsi", "samsumg", "apple", "sony", "macdonalds", "starbucks", "google" ]
}
categorias ={
    "1": "animales",
    "2": "alimentos",
...
def obtener_palabra_aleatoria():
    ...
    print("Tienes que adivinar la palabra de esta categoria.")
